...
const neighborhoods = [
  ...
  },
  {
    ...
    state: "NY",
    description:
      "Historic neighborhood with brownstone buildings, tree-lined streets, and stunning views of Manhattan.",
    image: "/placeholder.svg?height=300&width=500",
  ...
  },
  {
    ...
    state: "CA",
    description:
      "Diverse and eclectic neighborhood known for its vibrant arts scene, murals, and Latin American influence.",
    image: "/placeholder.svg?height=300&width=500",
    averagePrice: 950000,
    priceChange: 4.1,
    walkScore: 96,
    transitScore: 86,
    schools: 3.8,
    amenities: ["Restaurants", "Arts", "Parks", "Nightlife"],
    tags: ["Diverse", "Artistic", "Foodie"],
  },
  {
    id: "lake-view",
    name: "Lake View",
    city: "Chicago",
    state: "IL",
    description: "Popular residential area with a mix of historic homes and new developments near Lake Michigan.",
    image: "/placeholder.svg?height=300&width=500",
    averagePrice: 520000,
    priceChange: 2.9,
    walkScore: 91,
